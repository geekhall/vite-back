/*
 ...
 Source Schema         : db_yeb

 Target Server Type    : MySQL
 Target Server Version : 50734
 File Encoding         : 65001

 Date: 09/02/2022 21:54:21
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=862 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `t_joblevel` (
  ...
  `titleLevel` enum('正高级','副高级','中级','初级','员级','高级') DEFAULT NULL COMMENT '职称等级',
...
CREATE TABLE `t_mail_log` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '状态（0:消息投递中 1:投递成功 2:投递失败）',
...
) ENGINE=InnoDB AUTO_INCREMENT=883 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
delimiter ;;
CREATE PROCEDURE `p2`()
SELECT CONCAT('last_productre was',@last_proceudure)
;
;;
delimiter ;
